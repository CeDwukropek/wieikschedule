...
This section has moved here: [https://facebook.github.io/create-react-app/docs/troubleshooting#npm-run-build-fails-to-minify](https://facebook.github.io/create-react-app/docs/troubleshooting#npm-[...]

## License

This project is publicly visible for portfolio/demo purposes only.
Commercial use, resale, redistribution, or copying of the source code is not permitted
