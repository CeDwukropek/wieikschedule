          ...
          <div className="pointer-events-none absolute left-1/2 top-0 -translate-x-1/2 -translate-y-[100%]">
            ...
            {isChatMode ? (
              ...
              <button
                ...
                className={`pointer-events-auto -mb-[2px] rounded-t-[1rem] border-none bg-neutral-950 px-5 pt-2 text-center text-xs tracking-wide ${isCurrent ? "text-lime-400" : "text-neutral-300"} shadow-lg border-b-neutral-950`}
              >
                {label}
              </button>
            )}
