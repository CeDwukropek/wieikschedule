    ...
    <div className="sm:hidden">
      ...
      <button
        ...
        className={`fixed right-4 ${
          viewMode === "day" ? "bottom-[5rem]" : "bottom-4"
        } z-50 flex items-center justify-center w-12 h-12 rounded-full bg-neutral-800 hover:bg-neutral-700 text-white shadow-lg`}
      >
