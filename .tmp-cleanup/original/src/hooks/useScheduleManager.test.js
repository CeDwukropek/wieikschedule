...
import { getCachedTimetableById, getCachedTimetableOptions, loadAllTimetableOptions, loadTimetableById } from "../timetables";

jest.mock("../timetables", () => ({
...
jest.mock("../supabaseClient", () => ({ isSupabaseConfigured: true }));
